...
void CServerInfo::ReadConfig() // OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] Config Cargado Exitosamente");
}
...
void CServerInfo::ReadDumpList() // OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] DumpList Cargado Exitosamente");
}
...
void CServerInfo::ReadChecksumList() // OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] ChecksumList Cargado Exitosamente");
}
...
void CServerInfo::ReadInternalList() // OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] InternalList Cargado Exitosamente");
}
...
void CServerInfo::ReadWindowList() // OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] WindowList Cargado Exitosamente");
}
...
void CServerInfo::ReadBlackList() //OK
{
	...
	LogAdd(LOG_BLUE,"[ServerInfo] BlackList Cargado Exitosamente");
}
