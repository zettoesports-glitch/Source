...
void HackServerProtocolCore(BYTE head,BYTE* lpMsg,int size) // OK
{
	switch(head)
	{
		...
		case 0x11:
			...
			break;
		case 0x12:
			gProcessListInfo.RecvGetProcessDump((PMSG_GET_PROCESS_DUMP_RECV*)lpMsg);
			break;
		case 0x14:
			HCClientRebootRecv((SDHP_CLIENT_DISCONNECT_RECV*)lpMsg);
			break;
		case 0x15:
...
void CHClientInfoSend() // OK
{
	...
	gScreenCapture.State = 0;
	gScreenCapture.monitor_index = 0;
