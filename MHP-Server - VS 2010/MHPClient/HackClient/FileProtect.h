...
static const BYTE gFileProtectHeader[8] = {0x18,0x9B,0x09,0x7B,0xAA,0xFE,0xC1,0x97};
...
static const BYTE gFileProtectXorTable[16] = {63, 55, 59, 213, 141, 166, 239, 24, 232, 216, 202, 224, 219, 240, 45, 54};