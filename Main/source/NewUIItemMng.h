...
namespace SEASON3B
{
	...
	public:
		...
		ITEM* CreateItem(WORD byType, WORD bySubType, BYTE byLevel = 0, BYTE byDurability = 255, BYTE byOption1 = 0, BYTE byOptionEx = 0, BYTE byOption380 = 0, BYTE byOptionHarmony = 0	, BYTE * pbySocketOptions = NULL);	//. create instance
