...
bool SEASON3B::CNewUIHotKey::UpdateKeyEvent()
{
	...
	else if (SEASON3B::IsPress(VK_F9) == true)
	{
		SwitchKeyRight();
		PlayBuffer(SOUND_CLICK01);
		return false;
	...
	else if (SEASON3B::IsPress('C')) // LT (Trigger)
	{
	...
	else if (SEASON3B::IsPress('A')) //Bloqueio de Master Level
	{
	...
	else if(SEASON3B::IsPress(VK_TAB) == true && gMiniMap->MiniMapCheck(gMapManager.WorldActive) == true )
	{
