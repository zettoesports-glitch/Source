...
namespace SEASON3B
{
	...
	public:
		...
		bool Create(CNewUI3DRenderMng* pNew3DRenderMng, CNewUIItemMng* pNewItemMng, CNewUIObj* pOwner, int x, int y, int nColumn, int nRow, float DepthLayer = INVENTORY_CAMERA_Z_ORDER);
		void Release();
