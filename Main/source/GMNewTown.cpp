...
#else
		gMapManager.WorldActive == WD_77NEW_LOGIN_SCENE || gMapManager.WorldActive == WD_78NEW_CHARACTER_SCENE
#endif //PJH_NEW_SERVER_SELECT_MAP
		);
}
#ifdef PJH_NEW_SERVER_SELECT_MAP
...
void GMNewTown::CreateObject(OBJECT* pObject)
{
	...
	if (gMapManager.WorldActive == WD_77NEW_LOGIN_SCENE || gMapManager.WorldActive == WD_78NEW_CHARACTER_SCENE)
	{
		if (pObject->Type == 62)
		{
			pObject->SubType = 0;
...
bool GMNewTown::RenderObject(OBJECT* pObject, BMD* pModel, bool ExtraMon)
{
...
#ifndef PJH_NEW_SERVER_SELECT_MAP
	else if (gMapManager.WorldActive == WD_77NEW_LOGIN_SCENE &&
	...
	else if (gMapManager.WorldActive == WD_78NEW_CHARACTER_SCENE && pObject->Type == 4)
	{
