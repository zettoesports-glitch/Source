...
bool SEASON3B::CNewUIPurchaseShopInventory::UpdateMouseEvent()
{
	...
	//		//m_Button[MYSHOPINVENTORY_OPEN].ChangeButtonInfo(m_Pos.x + 13, m_Pos.y + 176, 36, 29);
	//		//m_Button[MYSHOPINVENTORY_CLOSE].ChangeButtonInfo(m_Pos.x + 53, m_Pos.y + 176, 36, 29);
	//	}
	//
	//	//if (m_EditBox)
	//	//{
...
{
	RenderImage(IMAGE_MSGBOX_BACK, m_Pos.x, m_Pos.y, 190.f, 214.5f);
	RenderImage(IMAGE_INVENTORY_BACK_TOP, m_Pos.x, m_Pos.y, 190.f, 64.f);
	RenderImage(IMAGE_INVENTORY_BACK_LEFT, m_Pos.x, m_Pos.y + 64, 21.f, 150.f);
	RenderImage(IMAGE_INVENTORY_BACK_RIGHT, m_Pos.x + 190 - 21, m_Pos.y + 64, 21.f, 150.f);
	RenderImage(IMAGE_INVENTORY_BACK_BOTTOM, m_Pos.x, m_Pos.y + 214 - 45, 190.f, 45.f);
