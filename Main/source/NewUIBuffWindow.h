...
namespace SEASON3B
{
    ...
    public:
        enum IMAGE_LIST
        {
            ...
            IMAGE_BUFF_STATUS2,
            IMAGE_BUFF_EXPAND,  // Imagem para seta de expansão
            IMAGE_BUFF_COLLAPSE // Imagem para seta de colapso
        };
    ...
    private:
        ...
        void RenderBuffTooltip(eBuffClass& eBuffClassType, eBuffState& eBuffType, float x, float y, int IndexTime);
        bool SetDisableRenderBuff(const eBuffState& _BuffState);
        void SavePositionToIni();
        void LoadPositionFromIni();
