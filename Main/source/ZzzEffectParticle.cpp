		...
		if(!o->Live)
		{
			...
			case BITMAP_FLAME:
                ...
                case 0:
					...
					{
						Vector(0.f, 0.f, (float)(rand() % 128 + 128) * 0.15f, o->Velocity);
						o->Scale = Scale * (float)(rand() % 54 + 64) * 0.004f;
					}
					else
					{
						Vector(0.f, 0.f, (float)(rand() % 128 + 128) * 0.15f, o->Velocity);
            ...
            case BITMAP_CLOUD:
				...
				if (gMapManager.WorldActive == WD_77NEW_LOGIN_SCENE && o->SubType == 3)
				{
     			    o->LifeTime = 30;
				    o->Gravity = (float)(rand()%1000);
		...
		if(o->Live)
		{
			...
			case BITMAP_FIRE_HIK3_MONO:
					...
					)
				{
					...
					{
						o->Alpha -= 0.2f; // Dấu 2
						//o->Alpha -= FPS_ANIMATION_FACTOR * 0.2f; // Dấu 2
					}
					else if (o->Alpha < 1.0f)
					{
						o->Alpha += (rand() % 2 + 2) * 0.1f; // Dấu 3
						//o->Alpha += FPS_ANIMATION_FACTOR * (rand() % 2 + 2) * 0.1f; // Dấu 3
					}
					else
					{
						o->Alpha = 1.0f;
