...
CNewUIEnterBloodCastle::CNewUIEnterBloodCastle()
{
	...
	m_iBloodCastleLimitLevel[0][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[0][0];  m_iBloodCastleLimitLevel[0][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[0][1];
	m_iBloodCastleLimitLevel[1][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[1][0];  m_iBloodCastleLimitLevel[1][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[1][1];
	m_iBloodCastleLimitLevel[2][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[2][0];  m_iBloodCastleLimitLevel[2][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[2][1];
	m_iBloodCastleLimitLevel[3][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[3][0];  m_iBloodCastleLimitLevel[3][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[3][1];
	m_iBloodCastleLimitLevel[4][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[4][0];  m_iBloodCastleLimitLevel[4][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[4][1];
	m_iBloodCastleLimitLevel[5][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[5][0];  m_iBloodCastleLimitLevel[5][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[5][1];
	m_iBloodCastleLimitLevel[6][0] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[6][0];  m_iBloodCastleLimitLevel[6][1] = gEventEntryLevel.m_BloodCastleEntryLevelCommon[6][1];
	m_iBloodCastleLimitLevel[7][0] = 0; m_iBloodCastleLimitLevel[7][1] = 0;


	m_iBloodCastleLimitLevel[8][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[0][0]; m_iBloodCastleLimitLevel[8][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[0][1];
	m_iBloodCastleLimitLevel[9][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[1][0]; m_iBloodCastleLimitLevel[9][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[1][1];
	m_iBloodCastleLimitLevel[10][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[2][0]; m_iBloodCastleLimitLevel[10][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[2][1];
	m_iBloodCastleLimitLevel[11][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[3][0]; m_iBloodCastleLimitLevel[11][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[3][1];
	m_iBloodCastleLimitLevel[12][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[4][0]; m_iBloodCastleLimitLevel[12][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[4][1];
	m_iBloodCastleLimitLevel[13][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[5][0]; m_iBloodCastleLimitLevel[13][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[5][1];
	m_iBloodCastleLimitLevel[14][0] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[6][0]; m_iBloodCastleLimitLevel[14][1] = gEventEntryLevel.m_BloodCastleEntryLevelSpecial[6][1];
