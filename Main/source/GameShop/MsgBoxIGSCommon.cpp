...
bool CMsgBoxIGSCommon::Create(float fPriority)
{
	...
	CNewUIMessageBoxBase::Create((GetWindowsX / 2) - (IMAGE_IGS_FRAME_WIDTH / 2), (IMAGE_IGS_WINDOW_HEIGHT / 2) - (IMAGE_IGS_FRAME_HEIGHT / 2), m_iMsgBoxWidth, m_iMsgBoxHeight, fPriority);
