...
void FormatDamageNumber(QWORD damage, char* outBuffer, size_t bufferSize)
{
	...
	{
		sprintf_s(outBuffer, bufferSize, "%.1fB", (double)damage / 1000000000.0);
	}
	else if (damage >= 1000000)
	{
		sprintf_s(outBuffer, bufferSize, "%.1fM", (double)damage / 1000000.0);
	}
	else if (damage >= 1000)
	{
		sprintf_s(outBuffer, bufferSize, "%.1fK", (double)damage / 1000.0);
	}
	else
	{
