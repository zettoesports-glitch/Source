...
public:
	...
	int m_AllowSocketHarmony;
	int m_MonsterLifeRate;
	int m_MonsterHealthBarSwitch;
	int m_PlayerHealthBarSwitch;
	int m_NonPK;
	int m_PKLimitFree;
	int m_PKDownTime1;
	int m_PKDownTime2;
	...
	int m_InvasionManagerMessageCountSwitch;
	int m_InvasionManagerMessagePlayerType;
	int m_InvasionManagerMessageGlobalType;
	int m_KanturuEvent;
	...
	int m_CommandMasterResetStrengthReq;
	int m_CommandMasterResetAgilityReq;
	int m_CommandMasterResetVitalityhReq;
	int m_CommandMasterResetEnergyReq;
	int m_CommandMasterResetCommandReq;
