...
//	BYTE send[256];
//
//	PMSG_CHARACTER_LIST_SEND pMsg; // pior que minha 5.2 ta full s6 n sei se da certo aqui, pqp kkk sera que da pra pegar da DinhoX? da sim, abre ai que te ajudo blz
//
