...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gEventEntryLevel.Load(gPath.GetFullPath("Custom\\CustomEventLevel.txt"));
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	gMonsterSetBase.LoadFolder(gPath.GetFullPath("Monster\\MonsterSetBase"));
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandCaseSensitive = GetPrivateProfileInt(section,"CommandCaseSensitive",0,path);
	...
	this->m_CommandMasterResetStrengthReq = GetPrivateProfileInt(section, "CommandMasterResetStrengthReq", 0, path);
	this->m_CommandMasterResetAgilityReq = GetPrivateProfileInt(section, "CommandMasterResetAgilityReq", 0, path);
	this->m_CommandMasterResetVitalityhReq = GetPrivateProfileInt(section, "CommandMasterResetVitalityhReq", 0, path);
	this->m_CommandMasterResetEnergyReq = GetPrivateProfileInt(section, "CommandMasterResetEnergyReq", 0, path);
	this->m_CommandMasterResetCommandReq = GetPrivateProfileInt(section, "CommandMasterResetCommandReq", 0, path);
	...
	this->m_CommandChangeClassToELF = GetPrivateProfileInt(section, "CommandChangeClassToFE", 0, path);
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_CloseServer = GetPrivateProfileInt(section, "CloseDelay", 0, path);
	...
	this->m_AllowSocketHarmony = GetPrivateProfileInt(section, "SocketItemHarmonySwitch", 0, path);
	...
	this->m_PlayerHealthBarSwitch = GetPrivateProfileInt(section,"PlayerHealthBarSwitch",0,path);
...
void CServerInfo::ReadEventInfo(char* section,char* path) // OK
{
	...
	this->m_InvasionManagerMessageCountSwitch = GetPrivateProfileInt(section, "InvasionManagerMessageCountSwitch", 0, path);

	this->m_InvasionManagerMessagePlayerType = GetPrivateProfileInt(section, "InvasionManagerMessagePlayerType", 0, path);

	this->m_InvasionManagerMessageGlobalType = GetPrivateProfileInt(section, "InvasionManagerMessageGlobalType", 0, path);
