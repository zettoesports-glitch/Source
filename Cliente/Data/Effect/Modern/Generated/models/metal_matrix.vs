// Runtime Matrix4x4 variant of vulkan-main/vulkan-main/Shaders/models/metal.vs.
// Keeps the reference material math while using the 4-texel Matrix4x4 skeleton atlas.
// Source contract: HLSL metal + common/SkeletonHelpers.inc with matrix storage.
...
void main()
{
    ...
    output_UV = normal.zy * 0.5 + vec2(0.2, 0.5);
