// Runtime Matrix4x4 variant of vulkan-main/vulkan-main/Shaders/models/chrome05.vs.
// Keeps the reference Chrome05 material math while using the 4-texel Matrix4x4 skeleton atlas.
...
void main()
{
    ...
    vec2 uv = normal.yz * vec2(3.0, 2.5) +
              vec2(GlobalConstantsData.ChromeWave.y * 5.0,
                   GlobalConstantsData.Wave.x);
    uv.y = -uv.y;
