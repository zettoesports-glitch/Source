// Runtime Matrix4x4 variant of vulkan-main/vulkan-main/Shaders/models/chrome04.vs.
// Keeps the reference material math while using the 4-texel Matrix4x4 skeleton atlas.
// Source contract: HLSL chrome04 + common/SkeletonHelpers.inc with matrix storage.
...
void main()
{
    ...
    vec2 uv = normal.yz * 0.5 +
              vec2(GlobalConstantsData.ChromeWave.y * 3.0,
                   GlobalConstantsData.Wave.x * 3.0);
    uv.y = -uv.y;
    output_UV = (vec2(dotr, 1.0 - dotr) + uv) + input_Data2.xy;
