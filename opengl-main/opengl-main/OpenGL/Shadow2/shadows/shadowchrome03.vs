// Generated from shadows/shadowchrome03.vs. Edit the HLSL source and regenerate this file.
...
ShadowPixelInput _main(VertexInput _input)
{
    ...
    else
    {
        ...
        float dotr = dot(normal, vec3(0.0, -0.100000001490116119384765625, -0.800000011920928955078125));
        _output.UV = vec2(dotr, 1.0 - dotr);
