// Generated from shadows/shadowchrome02.vs. Edit the HLSL source and regenerate this file.
...
ShadowPixelInput _main(VertexInput _input)
{
    ...
    else
    {
        ...
        _output.UV = ((normal.zy + normal.xx) * vec2(0.800000011920928955078125, 1.0)) + vec2(GlobalConstantsData.Wave.x * 2.0, GlobalConstantsData.Wave.x * 3.0);
