// Generated from shadows/shadowchrome05.vs. Edit the HLSL source and regenerate this file.
...
ShadowPixelInput _main(VertexInput _input)
{
    ...
    else
    {
        ...
        vec2 uv = (normal.yz * vec2(3.0, 2.5)) + vec2(GlobalConstantsData.ChromeWave.y * 5.0, GlobalConstantsData.Wave.x);
        uv.y = -uv.y;
        _output.UV = vec2(dotr, 1.0 - dotr) + uv;
