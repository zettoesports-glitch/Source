// Generated from shadows/shadowchrome01.vs. Edit the HLSL source and regenerate this file.
...
ShadowPixelInput _main(VertexInput _input)
{
    ...
    else
    {
        ...
        _output.UV = (normal.zy * 0.5) + vec2(GlobalConstantsData.Wave.x, GlobalConstantsData.Wave.x * 2.0);
