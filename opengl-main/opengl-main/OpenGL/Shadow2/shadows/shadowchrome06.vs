// Generated from shadows/shadowchrome06.vs. Edit the HLSL source and regenerate this file.
...
ShadowPixelInput _main(VertexInput _input)
{
    ...
    else
    {
        ...
        _output.UV = ((normal.zz + normal.xx) * 0.800000011920928955078125) + (GlobalConstantsData.Wave.yy * 2.0);
