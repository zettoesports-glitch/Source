// Generated from cloth/chrome03.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    float dotr = dot(_input.Normal, vec3(0.0, -0.100000001490116119384765625, -0.800000011920928955078125));
