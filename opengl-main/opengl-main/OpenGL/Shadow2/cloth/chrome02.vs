// Generated from cloth/chrome02.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    _output.UV = ((_input.Normal.zy + _input.Normal.xx) * vec2(0.800000011920928955078125, 1.0)) + vec2(GlobalConstantsData.Wave.x * 2.0, GlobalConstantsData.Wave.x * 3.0);
