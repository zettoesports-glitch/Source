// Generated from cloth/chrome06.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    _output.UV = ((_input.Normal.zz + _input.Normal.xx) * 0.800000011920928955078125) + (GlobalConstantsData.Wave.yy * 2.0);
