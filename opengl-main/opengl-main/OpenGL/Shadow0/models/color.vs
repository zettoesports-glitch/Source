// Generated from models/color.vs. Edit the HLSL source and regenerate this file.
...
layout(location = 1) flat out float output_MinAlpha;
...
ColorPixelInput _main(VertexInput _input)
{
    uint param = _input.BoneIndex;
    uint param_1 = _input.Bones.x;
    mat4 _231 = RequestBone(param, param_1);
    mat4 BoneMatrix = _231;
    ColorPixelInput _output;
    ...
    vec4 Normal = BoneMatrix * vec4(_input.Normal, 0.0);
    _output.Position += (Normal * _input.BodyScale.y);
    vec4 _282 = _output.Position;
    vec3 _284 = _282.xyz * _input.BodyScale.x;
    _output.Position.x = _284.x;
    _output.Position.y = _284.y;
    _output.Position.z = _284.z;
    vec4 _295 = _output.Position;
    vec3 _297 = _295.xyz + _input.BodyOrigin;
    _output.Position.x = _297.x;
    _output.Position.y = _297.y;
    _output.Position.z = _297.z;
...
void main()
{
    ...
    ColorPixelInput flattenTemp = _main(param);
