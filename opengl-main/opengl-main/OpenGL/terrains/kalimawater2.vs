// Generated from terrains/kalimawater2.vs. Edit the HLSL source and regenerate this file.
...
layout(location = 2) out vec4 output_LightPos;
...
{
    PixelInput _output;
    _output.LightPos = _input.Position * spvWorkaroundRowMajor(GlobalConstantsData.Shadow);
    _output.Position = _input.Position * spvWorkaroundRowMajor(GlobalConstantsData.Game3D);
    float lum = 1.0 - dot(_input.Normal, TransformVector);
    _output.Color = vec4(lum, lum * 2.5, lum * 3.0, 1.0);
