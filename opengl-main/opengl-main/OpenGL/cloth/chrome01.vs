// Generated from cloth/chrome01.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    _output.UV = (_input.Normal.zy * 0.5) + vec2(GlobalConstantsData.Wave.x, GlobalConstantsData.Wave.x * 2.0);
