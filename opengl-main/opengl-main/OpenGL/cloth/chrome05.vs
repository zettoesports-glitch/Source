// Generated from cloth/chrome05.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    vec2 uv = (_input.Normal.yz * vec2(3.0, 2.5)) + vec2(GlobalConstantsData.ChromeWave.y * 5.0, GlobalConstantsData.Wave.x);
    uv.y = -uv.y;
