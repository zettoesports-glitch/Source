// Generated from cloth/chrome07.vs. Edit the HLSL source and regenerate this file.
...
PixelInput _main(ClothVertexInput _input)
{
    ...
    _output.UV = ((_input.Normal.zz + _input.Normal.xx) * 0.800000011920928955078125) + (vec2(GlobalConstantsData.WorldTime, GlobalConstantsData.WorldTime) * 5.9999998484272509813308715820312e-05);
